...
def pilog():
    ...
    if og == '1':
        ...
        print logo
        print
        print '\x1b[1;91mCopy Token For Free From RASHED HOSSAIN'
        print ' '
        print ' '
...
def menu():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print '[!] RASHED Failed To Load. Your Checkpoint account'
        os.system('rm -rf .logfuck.txt')
        time.sleep(1)
        logmen()
    ...
    print ' '
    print '[1] Start Hacking With RASHED'
...
def pil():
    ...
    if ti == '1':
        ...
        os.system('rm -rf .logfuck.txt')
        print '[\xe2\x88\x9a] RASHED Deleting Token Successfully.'
        time.sleep(1)
        os.system('exit')
        logmen()
    else:
...
def cramen():
    ...
    os.system('clear')
    print logo
    print '[1] RASHED Crack From Public Id'
...
def crapil():
    ...
    time.sleep(0.5)
    print ' RASHED SAID PLEASE WAIT YOUR CLONING ACCOUNT WILL BE SHOW HERE'
    print '\n\x1b[1;97m\xc2\xab-----\x1b[1;91m\xe3\x80\x90To RASHED Stop Process Press CTRL+Z\xe3\x80\x91\x1b[1;97m----\xc2\xbb'
    ...
    p.map(main, id)
    print ''
    print '[\xe2\x9c\x93] RASHED Total CP/\x1b[1:32mOK:\x1b[0;97m  ' + str(len(cps)) + '/\x1b[;32m \x1b[0;97m' + str(len(oks))
    ...
    print '  \x1b[1;91m\xc2\xab---\xe2\x80\xa2\xe2\x97\x88\xe2\x80\xa2---Developed By RASHED-HOSSAIN--\xe2\x80\xa2\xe2\x97\x88\xe2\x80\xa2---\xc2\xbb'
    print '\x1b[1;95m RASHED Process Has Been Completed Press\xe2\x9e\xa1 Type 0 Enter\xe2\x86\xa9 Next Type 0 (logout)\xe2\x86\xa9\x1b[1;97m....'
    raw_input('Back')
    menu()
